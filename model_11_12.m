%% Milne Fiord Epishelf Lake model for 2011-2012
...
%% VALUES
t0=datenum(2011,09,01);  % start time
tf=datenum(2012,06,01);  % final time
...
% some trim to make it faster
SAeval.SAmatrix=SA_data.temp_11_12;
SAeval.Y=SA_data.Y_11_12;
SAeval.Time=SA_data.time_11_12;
SAeval.SAmatrix=SAeval.SAmatrix(1:4,:); %unnecessary row
...
CTmatrix=TBC(CTmatrix,t0,tf,dt,y_top,y_bot); %known temperature at top and bottom
%filling NaN spots in temperature IC
CTmatrix(1,:)=fillmissing(CTmatrix(1,:),'linear');
CTmatrix(end,:)=fillmissing(CTmatrix(end,:),'linear');
...
% Ca. Then another year is simulated using a different pair of outflow coef.
% The model output with the best coefficient of agreement is written in a
% structure.

% Parameters values
h0=[6.7];                                    %minimum ice shelf draft array
coef=[2.5];                                  %friction*width coef array
...
%% structure
weir_01sept2011_01jun2012.SAmatrix=SAmatrix;
weir_01sept2011_01jun2012.SAdiff=SAdiff;
weir_01sept2011_01jun2012.SAmooring=SAmooring;
weir_01sept2011_01jun2012.SAmooring_Y=Ymooring;
weir_01sept2011_01jun2012.SAstats=SAstats;
weir_01sept2011_01jun2012.CTmatrix=CTmatrix;
weir_01sept2011_01jun2012.CTdiff=CTdiff;
weir_01sept2011_01jun2012.CTmooring=CTmooring;
weir_01sept2011_01jun2012.CTstats=CTstats;
weir_01sept2011_01jun2012.outflow=Outflow;
weir_01sept2011_01jun2012.time=time;
weir_01sept2011_01jun2012.K_CT_top=K_CT_top;
weir_01sept2011_01jun2012.K_CT_bot=K_CT_bot;
weir_01sept2011_01jun2012.K_SA_top=K_SA_top;
weir_01sept2011_01jun2012.K_SA_bot=K_SA_bot;
weir_01sept2011_01jun2012.Ca=Ca;
weir_01sept2011_01jun2012.h0=h0;
weir_01sept2011_01jun2012.coef=coef;
%saving a file with the final outputs
save 01sept2011_01jun2012_h067_Cb25.mat weir_01sept2011_01jun2012
